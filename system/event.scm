(module system racket/base
	...
	(provide (contract-out
		...
		(alarm! (->* (connection? rational?) (#:id symbol?) #:rest list? symbol?))
		(timeout! (->* (connection? rational?) (#:id symbol?) #:rest list? symbol?))
		(interval! (->* (connection? rational?) (#:id symbol?) #:rest list? symbol?))
